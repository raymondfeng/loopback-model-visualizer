...
VizVisualizer.renderGraph = function render(rootName, object, options) {
    var visualizer = new VizVisualizer(options);
    var graph = new ObjectGraph(rootName, object, options);
    var viz = visualizer.graphToViz(graph, options.excludingNulls);
    return viz;
...
VizVisualizer.prototype.graphToViz = function graphToViz(graph, excludingNulls) {
    var self = this;
    return '' +
        'digraph g {\n' +
        '  graph [\n' +
...
VizVisualizer.prototype.nodeToViz = function nodeToViz(node, excludingNulls) {
    var self = this;
    return '' +
        '  "' + node.id() + '" [label=<\n' +
